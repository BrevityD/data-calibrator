...
os.system('huggingface-cli download --repo-type dataset --resume-download bigcode/bigcodebench --local-dir ./datasets/code_domain/bigcodebench --local-dir-use-symlinks False')  # 用于下载数据集
